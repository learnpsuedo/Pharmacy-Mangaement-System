...
public class PaymentController {
   ...
   public String onlinePayment(@PathVariable int amount) throws RazorpayException
   {
	   ...
	   RazorpayClient client=new RazorpayClient("rzp_test_T6YHevOgAHCxIt","bTGDyRGjfNKfm6J1vMz3i7YX"
	   		+ "" );
   ...
   public String deletePaymentBypaymentId(@PathVariable int profileId)
   {
	  return paymentService.deletePaymentById(profileId);
   }
